...
-module(rfc4006_cc_Gy).

-compile({parse_transform, diameter_exprecs}).

-compile(nowarn_unused_function).

-export_records([rfc4006_cc_Gy_CCR, rfc4006_cc_Gy_CCA,
		 'rfc4006_cc_Gy_Cost-Information',
		 'rfc4006_cc_Gy_Unit-Value',
		 'rfc4006_cc_Gy_Multiple-Services-Credit-Control',
		 'rfc4006_cc_Gy_Granted-Service-Unit',
		 'rfc4006_cc_Gy_Requested-Service-Unit',
		 'rfc4006_cc_Gy_Used-Service-Unit',
		 'rfc4006_cc_Gy_CC-Money',
		 'rfc4006_cc_Gy_G-S-U-Pool-Reference',
		 'rfc4006_cc_Gy_Final-Unit-Indication',
		 'rfc4006_cc_Gy_Redirect-Server',
		 'rfc4006_cc_Gy_Service-Parameter-Info',
		 'rfc4006_cc_Gy_Subscription-Id',
		 'rfc4006_cc_Gy_User-Equipment-Info',
...
rec2msg(rfc4006_cc_Gy_CCR) -> 'CCR';
rec2msg(rfc4006_cc_Gy_CCA) -> 'CCA';
rec2msg(_) -> erlang:error(badarg).

msg2rec('CCR') -> rfc4006_cc_Gy_CCR;
msg2rec('CCA') -> rfc4006_cc_Gy_CCA;
msg2rec(_) -> erlang:error(badarg).

name2rec('Cost-Information') ->
    'rfc4006_cc_Gy_Cost-Information';
name2rec('Unit-Value') -> 'rfc4006_cc_Gy_Unit-Value';
...
name2rec('Used-Service-Unit') ->
    'rfc4006_cc_Gy_Used-Service-Unit';
name2rec('CC-Money') -> 'rfc4006_cc_Gy_CC-Money';
...
avp_name(5, undefined) ->
    {'3GPP-GPRS-Neg-QoS-Profile', 'UTF8String'};
avp_name(8, undefined) ->
    {'3GPP-IMSI-MCC-MNC', 'UTF8String'};
avp_name(23, undefined) ->
    {'3GPP-MS-Time-Zone', 'OctetString'};
avp_name(10, undefined) -> {'3GPP-NSAPI', 'UTF8String'};
avp_name(3, undefined) ->
    {'3GPP-PDP-Type', 'Unsigned32'};
avp_name(21, undefined) ->
    {'3GPP-RAT-Type', 'OctetString'};
...
avp_name(846, undefined) -> {'CG-Address', 'Address'};
...
avp_name(847, undefined) -> {'GGSN-Address', 'Address'};
...
avp_name(1227, undefined) -> {'PDP-Address', 'Address'};
avp_name(874, undefined) ->
    {'PS-Information', 'Grouped'};
...
avp_arity('Service-Information', 'PS-Information') ->
    {0, 1};
avp_arity('PS-Information', '3GPP-Charging-Id') -> 1;
avp_arity('PS-Information', '3GPP-PDP-Type') -> 1;
avp_arity('PS-Information', 'PDP-Address') -> 1;
avp_arity('PS-Information',
	  '3GPP-GPRS-Neg-QoS-Profile') ->
    1;
avp_arity('PS-Information', 'SGSN-Address') -> 1;
avp_arity('PS-Information', 'GGSN-Address') -> 1;
avp_arity('PS-Information', 'CG-Address') -> 1;
avp_arity('PS-Information', '3GPP-IMSI-MCC-MNC') -> 1;
avp_arity('PS-Information', '3GPP-GGSN-MCC-MNC') -> 1;
avp_arity('PS-Information', '3GPP-NSAPI') -> 1;
avp_arity('PS-Information', 'Called-Station-Id') -> 1;
avp_arity('PS-Information', '3GPP-Selection-Mode') -> 1;
avp_arity('PS-Information',
	  '3GPP-Charging-Characteristics') ->
    1;
avp_arity('PS-Information', '3GPP-SGSN-PLMN-Id') -> 1;
avp_arity('PS-Information', '3GPP-MS-Time-Zone') -> 1;
avp_arity('PS-Information',
...
avp_header('3GPP-Charging-Characteristics') ->
    {13, 64, undefined};
avp_header('3GPP-Charging-Id') -> {2, 64, undefined};
avp_header('3GPP-GGSN-MCC-MNC') -> {9, 64, undefined};
avp_header('3GPP-GPRS-Neg-QoS-Profile') ->
    {5, 64, undefined};
avp_header('3GPP-IMSI-MCC-MNC') -> {8, 64, undefined};
avp_header('3GPP-MS-Time-Zone') -> {23, 64, undefined};
avp_header('3GPP-NSAPI') -> {10, 64, undefined};
avp_header('3GPP-PDP-Type') -> {3, 64, undefined};
avp_header('3GPP-RAT-Type') -> {21, 64, undefined};
avp_header('3GPP-SGSN-PLMN-Id') -> {18, 64, undefined};
...
avp_header('CG-Address') -> {846, 64, undefined};
...
avp_header('G-S-U-Pool-Reference') ->
    {457, 64, undefined};
avp_header('GGSN-Address') -> {847, 64, undefined};
...
avp_header('Multiple-Services-Indicator') ->
    {455, 64, undefined};
avp_header('PDP-Address') -> {1227, 64, undefined};
avp_header('PS-Information') -> {874, 64, undefined};
...
avp(T, Data, '3GPP-GGSN-MCC-MNC') ->
    diameter_types:'UTF8String'(T, Data);
avp(T, Data, '3GPP-GPRS-Neg-QoS-Profile') ->
    diameter_types:'UTF8String'(T, Data);
avp(T, Data, '3GPP-IMSI-MCC-MNC') ->
    diameter_types:'UTF8String'(T, Data);
avp(T, Data, '3GPP-MS-Time-Zone') ->
    diameter_types:'OctetString'(T, Data);
...
dict() ->
    [1,
     {avp_types,
      [{"3GPP-CAMEL-Charging-Info", 24, "UTF8String", "M"},
       {"3GPP-Charging-Characteristics", 13, "OctetString",
	"M"},
       {"3GPP-Charging-Id", 2, "Unsigned32", "M"},
       {"3GPP-GGSN-MCC-MNC", 9, "UTF8String", "M"},
       {"3GPP-GPRS-Neg-QoS-Profile", 5, "UTF8String", "M"},
       {"3GPP-IMSI-MCC-MNC", 8, "UTF8String", "M"},
       {"3GPP-MS-Time-Zone", 23, "OctetString", "M"},
       {"3GPP-NSAPI", 10, "UTF8String", "M"},
       {"3GPP-PDP-Type", 3, "Unsigned32", "M"},
       {"3GPP-RAT-Type", 21, "OctetString", "M"},
       {"3GPP-SGSN-PLMN-Id", 18, "OctetString", "M"},
       {"3GPP-Selection-Mode", 12, "UTF8String", "M"},
       {"3GPP-User-Location-Info", 22, "UTF8String", "M"},
	...
	"M"},
       ...
       {"PDP-Address", 1227, "Address", "M"},
       {"PS-Information", 874, "Grouped", "M"},
	...
	[{"THRESHOLD", 0}, {"QHT", 1}, {"FINAL", 2},
	 {"QUOTA_EXAUSTED", 3}, {"VALIDITY_TIME", 4},
	...
	[{{"Session-Id"}}, {"Result-Code"}, {"Origin-Host"},
	 ...
	 {'*', ["AVP"]}]}]},
     {name, "rfc4006_cc_Gy"}, {prefix, "rfc4006_cc_Gy"}].
