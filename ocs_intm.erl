...
%%
generate_req(initial, {APN, IMSI, MSISDN, Location, SessionId, EventTimestamp, ConsumedResources, ServiceID, RatingGroup}) ->
...
generate_req(update, {APN, IMSI, MSISDN, Location, SessionId, EventTimestamp, ConsumedResources, ServiceID, RatingGroup}) ->
    StartTime = timestamp(EventTimestamp),
...
generate_req(terminate, {APN, IMSI, MSISDN, Location, SessionId, EventTimestamp, ConsumedResources, ServiceID, RatingGroup}) ->
    StartTime = timestamp(EventTimestamp),
